...
#--    Stato_Server
#-- --------------------------------------
DROP TABLE IF EXISTS `Stato_Server`;

CREATE TABLE `Stato_Server` (
`Server` VARCHAR(15),
`Stato` INT(11),
`StatoDesc` VARCHAR(50),
`Data` VARCHAR(25));

ALTER TABLE `Stato_Server` ADD `id` INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (`id`);
...
ALTER TABLE `Stato_Istanza` ADD `id` INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (`id`);
